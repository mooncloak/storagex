...
fun MavenPublication.mavenCentralPom() {
    pom {
        name.set("storagex")
        description.set("Compose Multiplatform storage utilities.")
        url.set("https://github.com/mooncloak/storagex")
        ...
        issueManagement {
            url.set("https://github.com/mooncloak/storagex/issues")
        ...
        developers {
            ...
            developer {
                ...
                roles.set(setOf("Primary storagex developer. 💪"))
            }
        }

        scm {
            connection.set("https://github.com/mooncloak/storagex.git")
            developerConnection.set("https://github.com/mooncloak/storagex.git")
            url.set("https://github.com/mooncloak/storagex")
        }
    }
}
